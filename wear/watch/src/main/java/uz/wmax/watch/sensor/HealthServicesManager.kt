    ...
    fun heartRateFlow(): Flow<MeasureEvent> = callbackFlow {
        val callback = object : MeasureCallback {
            ...
            override fun onDataReceived(data: DataPointContainer) {
                ...
                // SpO2 support varies by vendor and is not exposed by the
                // stable MeasureClient API used here. Unsupported values stay
                // null instead of being synthesized as clinical data.
            }
        }
