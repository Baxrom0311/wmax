...
export const MOCK_RELATIVE_VIEW_PRO: RelativeView = {
  ...
  series: [
    ...
    {
      param: "rr_est",
      points: generateSeriesPoints(17.5, 1.2, 0.5),
      baseline_median: 16.0,
      baseline_low: 13.0,
      baseline_high: 19.0,
      deviated_ranges: [],
    },
    {
      param: "sleep_frag",
      points: generateSeriesPoints(6.2, 0.6, -0.2),
      baseline_median: 7.5,
      baseline_low: 6.0,
      baseline_high: 8.5,
      deviated_ranges: [],
    ...
    {
      param: "steps",
      points: generateSeriesPoints(3200, 600, -300),
      baseline_median: 4500,
      baseline_low: 3000,
      baseline_high: 6000,
      deviated_ranges: [],
    },
...
export const MOCK_RELATIVE_VIEW_STABLE: RelativeView = {
  ...
  series: [
    ...
    {
      param: "skin_temp",
      points: generateSeriesPoints(36.4, 0.15),
    ...
    {
      param: "rmssd",
      points: generateSeriesPoints(44, 3.0),
    ...
    {
      param: "rr_est",
      points: generateSeriesPoints(15.5, 0.8),
      baseline_median: 15.5,
      baseline_low: 13.0,
      baseline_high: 18.0,
      deviated_ranges: [],
    },
    {
      param: "sleep_frag",
      points: generateSeriesPoints(7.2, 0.4),
      baseline_median: 7.2,
      baseline_low: 6.5,
      baseline_high: 8.0,
      deviated_ranges: [],
    ...
    {
      param: "steps",
      points: generateSeriesPoints(4200, 400),
      baseline_median: 4200,
      baseline_low: 3500,
      baseline_high: 5500,
      deviated_ranges: [],
    },
